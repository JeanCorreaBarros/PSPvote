...
export function AddPuestoDialog({ onPuestoAdded }: AddPuestoDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true)
      console.log("Puesto agregado:", formData)
      ...
      setError("Error al agregar puesto. Intenta de nuevo.")
      console.error(err)
    } finally {
      setIsLoading(false)
    }
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-screen overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Crear Nuevo Puesto de Votación</DialogTitle>
          <DialogDescription>
            Completa el formulario para registrar un nuevo puesto de votación en el sistema
          </DialogDescription>
        </DialogHeader>
          ...
          {success && (
            <Alert className="bg-green-50 border-green-200">
              ...
              <AlertDescription className="text-green-700">
                Puesto de votación agregado exitosamente
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input
                id="direccion"
                name="direccion"
                placeholder="Calle 45 #12-34, Centro"
